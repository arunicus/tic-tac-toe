...
const O = 'O';
/* harmony export (immutable) */ __webpack_exports__["a"] = O;
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__node_modules_redux__ = __webpack_require__(15);
throw new Error("Cannot find module \"../../node_modules/PolymerRedux\"");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_tic_tac_redux_src_tictacredux_js__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__node_modules_polymer_polymer_polymer_element_js__ = __webpack_require__(35);

// <link rel="import" href="../../web_modules/polymer-redux/polymer-redux.html">
// <script src="../../node_modules/redux/dist/redux.js" ></script>
// <script src="../../node_modules/tic-tac-redux/src/tictacredux.js" as="tictac" type="module"></script>
...
const store = Object(__WEBPACK_IMPORTED_MODULE_0__node_modules_redux__["a" /* createStore */])(tictac.gameReducer, tictac.initialState)

// // Create the PolymerRedux mixin
// const ReduxMixin = PolymerRedux(store)

class TicTacPolymerApp extends __WEBPACK_IMPORTED_MODULE_3__node_modules_polymer_polymer_polymer_element_js__["a" /* Element */] {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__actions_actions__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__reducers_gameReducer__ = __webpack_require__(34);
/* unused harmony reexport addSymbol */
/* unused harmony reexport startAgain */
/* unused harmony reexport initialState */
/* unused harmony reexport gameReducer */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__logic_logic__ = __webpack_require__(32);



const addSymbol = (boardState, row, position, symbol) => {
  let newState = Object(__WEBPACK_IMPORTED_MODULE_0__logic_logic__["a" /* playMove */])(boardState, row, position, symbol);
...
/* unused harmony export addSymbol */


const startAgain = () => ({
  type: 'START_AGAIN'
});
/* unused harmony export startAgain */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__symbols_symbols__ = __webpack_require__(12);
...
/* unused harmony export hasThreatInRow */
...
const hasThreatInColumn = (symbol, colNumber, ...rows) => countInColumn(symbol, colNumber, ...rows) === 2;
/* unused harmony export hasThreatInColumn */
...
const hasThreatInLeftSlant = (symbol, ...rows) => countInLeftSlant(symbol, ...rows) === 2;
/* unused harmony export hasThreatInLeftSlant */
...
const hasThreatInRightSlant = (symbol, ...rows) => countInRightSlant(symbol, ...rows) === 2;
/* unused harmony export hasThreatInRightSlant */
...
/* unused harmony export resultForSymbol */


const playMove = (boardState, row, position, symbol) => {
  const newBoard = __WEBPACK_IMPORTED_MODULE_1_lodash__["cloneDeep"](boardState);
  const newState = { board: newBoard }
  newState.board[row][position].value = symbol;

  const xResult = resultForSymbol(__WEBPACK_IMPORTED_MODULE_0__symbols_symbols__["b" /* X */], newState.board);
  const oResult = resultForSymbol(__WEBPACK_IMPORTED_MODULE_0__symbols_symbols__["a" /* O */], newState.board);

  if (xResult.won) {
    newState.won = __WEBPACK_IMPORTED_MODULE_0__symbols_symbols__["b" /* X */];
  ...
  if (oResult.won) {
    newState.won = __WEBPACK_IMPORTED_MODULE_0__symbols_symbols__["a" /* O */];
  ...
  if (!newState.won) {
    newState.turn = symbol === __WEBPACK_IMPORTED_MODULE_0__symbols_symbols__["a" /* O */] ? __WEBPACK_IMPORTED_MODULE_0__symbols_symbols__["b" /* X */] : __WEBPACK_IMPORTED_MODULE_0__symbols_symbols__["a" /* O */];
  }
...
/* harmony export (immutable) */ __webpack_exports__["a"] = playMove;
...
const initialState = {
  ...
  won: undefined,
  draw: false,
  turn: __WEBPACK_IMPORTED_MODULE_0__symbols_symbols__["a" /* O */]
};
...
/* unused harmony export gameReducer */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_style_gather_js__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utils_resolve_url_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__elements_dom_module_js__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__property_effects_js__ = __webpack_require__(39);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_path_js__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_case_map_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__property_accessors_js__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__template_stamp_js__ = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_async_js__ = __webpack_require__(42);
